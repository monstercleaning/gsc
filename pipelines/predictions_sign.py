...
Implements the signing protocol documented in METHOD.md.

Usage:
    python3 pipelines/predictions_sign.py P1
    python3 pipelines/predictions_sign.py P1 --gpg-key <key-id>
    python3 pipelines/predictions_sign.py --list

Status: SCAFFOLD — protocol defined, full GPG integration pending (M201).

The signing operation:

1. Verifies the prediction directory exists at predictions/<ID>/.
