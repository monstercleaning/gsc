...
violation at >= 3 sigma falsifies T1 outright (THEORY.md, kill condition K1).
...
REGISTER = REPO_ROOT / "predictions" / "P11_distance_duality"
...
def main(argv=None) -> int:
    ...
    interp = (
        ...
        "(THEORY.md, kill conditions K0/K1)."
        if passed
        ...
        "(THEORY.md, kill condition K1); no correction may be invoked to rescue it."
    )
    ...
    card = "\n".join([
        ...
        "",
        "```bash",
        "python3 pipelines/predictions_compute_P11.py",
        "python3 pipelines/predictions_score_P11.py",
        "```",
        "",
    ])
