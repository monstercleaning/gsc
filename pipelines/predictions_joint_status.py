...
Reads each predictions/PN_*/scorecard.md (where present) and produces
...
Usage:
    python3 pipelines/predictions_joint_status.py
    python3 pipelines/predictions_joint_status.py --format json
"""
...
def render_text(rows: list[dict], notes: list[str]) -> str:
    ...
    lines.append(
        ...
        "    python3 pipelines/predictions_score_P4.py\n"
        "    python3 pipelines/predictions_score_P5.py\n"
        "    python3 pipelines/predictions_score_P6.py\n"
        "    python3 pipelines/predictions_score_P7.py\n"
        "    python3 pipelines/predictions_joint_status.py\n"
    )
