...
Usage:
    ...
    python3 scripts/predictions_compute_P8.py --output predictions/P08_redshift_drift/pipeline_output.json
...
def make_record(*, ansatz: str, params: dict, H0_km_s_Mpc: float, Omega_m: float,
    ...
    r1_path = REPO_ROOT / "predictions" / "P08_redshift_drift" / R1_SUPERSEDED_FILE
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output", type=Path,
        default=REPO_ROOT / "predictions" / "P08_redshift_drift" / "pipeline_output.json",
    )
