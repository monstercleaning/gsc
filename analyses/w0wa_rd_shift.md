...
magnitude only. Script: `analyses/w0wa_rd_shift_diagnostic.py`;
deterministic artifact: `analyses/w0wa_rd_shift_diagnostic.json`.
...
- Data model: the five DESI DR1 tracers with their real per-tracer
  uncertainties and D_M–D_H correlations (`data/desi_dr1_bao_baseline.csv`), central values
