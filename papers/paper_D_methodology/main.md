...
We implement these four components in the GSC framework's reproducibility stack and demonstrate the operational workflow end-to-end on eleven registered cosmological predictions. The stack is licensed under MIT and available at the project repository.
...
We demonstrate the workflow on the eleven registered predictions of the GSC framework. Detailed prediction records are at `predictions_register/P1`–`P11`; here we summarise the methodological aspects.
