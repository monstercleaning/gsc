...
SCRIPT = ROOT / "scripts" / "phase4_triangle1_joint_sn_bao_epsilon_posterior.py"
ABS_TOKENS = ("/Users/", "/home/", "/var/folders/", "C:\\Users\\")


class TestPhase4M157Triangle1JointSnBaoDeterminismToy(unittest.TestCase):
    def test_report_and_png_are_deterministic_and_portable(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            json_a = out_a / "TRIANGLE1_JOINT_SN_BAO_REPORT.json"
            json_b = out_b / "TRIANGLE1_JOINT_SN_BAO_REPORT.json"
            md_a = out_a / "TRIANGLE1_JOINT_SN_BAO_REPORT.md"
            md_b = out_b / "TRIANGLE1_JOINT_SN_BAO_REPORT.md"
            ...
            self.assertEqual(payload.get("schema"), "phase4_triangle1_joint_sn_bao_epsilon_posterior_report_v1")
            ...
            self.assertEqual(artifact_sha.get("TRIANGLE1_JOINT_SN_BAO_REPORT.md"), hashlib.sha256(md_a.read_bytes()).hexdigest())
