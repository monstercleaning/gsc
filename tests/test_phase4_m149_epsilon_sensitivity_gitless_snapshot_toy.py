...
SENSITIVITY_SCRIPT = ROOT / "scripts" / "phase4_epsilon_sensitivity_matrix_toy.py"
ABS_TOKENS = ("/Users/", "/home/", "/var/folders/", "C:\\\\Users\\\\")


class TestPhase4M149EpsilonSensitivityGitlessSnapshotToy(unittest.TestCase):
    def test_gitless_snapshot_run_emits_portable_report(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            outdir = snapshot_repo_root / "out" / "epsilon_sensitivity_gitless"
