...
- It **is** a standing **sudden-death falsification channel**: any robust
  ...
  the forward set (kill condition K0 (THEORY.md)), a **single** confirmed violation suffices
  (kill condition K1 (THEORY.md)).
...
- `pipelines/predictions_compute_P11.py` — deterministic, parameter-free output.
- `pipelines/predictions_score_P11.py` — scores η₁ against the recorded constraint.
...
and no unimplemented correction may be invoked to rescue it (kill condition K0 (THEORY.md)).
