...
- It **is** a standing **sudden-death falsification channel**: a robust
  Ξ₀ ≠ 1 detection falsifies T1 outright (kill condition K1 (THEORY.md), tensor-sector extension).
...
- `pipelines/predictions_compute_P13.py` — deterministic, parameter-free output.
- `pipelines/predictions_score_P13.py` — scores Ξ₀ against the recorded constraint.
...
sudden-death extension of kill condition K1 (THEORY.md). No tier-demotion, non-universal
