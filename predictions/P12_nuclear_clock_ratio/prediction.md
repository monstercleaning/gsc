...
- It **is** a standing **sudden-death falsification channel** (kill condition K2 (THEORY.md)): a
...
package enforced by kill condition K2 (THEORY.md).

## Pipeline

- `pipelines/predictions_compute_P12.py` — deterministic, parameter-free output.
...
sudden-death clause kill condition K2 (THEORY.md). No tier-demotion, non-universal extension, or
